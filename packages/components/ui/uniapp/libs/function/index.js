import { number as testNumber, array as testArray, empty as testEmpty } from './test.js';
...
/**
 * @description 在tsm-form的子组件内容发生变化，或者失去焦点时，尝试通知tsm-form执行校验方法
 * @param {*} instance
 * @param {*} event
 */
export function formValidate(instance, event) {
  const formItem = $parent.call(instance, 'tsm-form-item');
  const form = $parent.call(instance, 'tsm-form');
  // 如果发生变化的input或者textarea等，其父组件中有tsm-form-item或者tsm-form等，就执行form的validate方法
